...
if (-not (Test-Path $CsvFile)) {
    ...
    Write-Host "Pemakaian: .\release_voucher.ps1 -CsvFile 'promo_id.csv'"
    exit 1
}
$timestamp = Get-Date -Format "yyyyMMdd_HHmmss"
$LogFolder = "D:\mybot\tools\promovoucher\logs"
...
$logFile = Join-Path $LogFolder "release_log_$timestamp.csv"
